		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project BrowseOrders in Prodev",
									"targetURL": "#comlab2devbrowseordersprodev-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbrowseordersprodev-display": {
								"semanticObject": "comlab2devbrowseordersprodev",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.browseordersprodev",
									"url": sap.ui.require.toUrl("com/lab2dev/browseordersprodev")
								}
							}
						}
					}
